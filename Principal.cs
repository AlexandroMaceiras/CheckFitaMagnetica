...
namespace CheckFitaMagnetica
{
	...
	public class Principal : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.textBox1.Tag = "5";
            this.textBox1.Text = "D:\\CheckFitaMagnetica";
            // 
            // button1
            // 
		...
		private void button2_Click(object sender, System.EventArgs e)
		 {
			...
			try
			{
				if(textBox1.Text.Length > 0)
				{
                    ...
                    DirectoryInfo ddd = new DirectoryInfo(@"D:\CheckFitaMagnetica");
					...
					{
						StreamWriter writer = File.CreateText(@"D:\CheckFitaMagnetica\Log_de_Erros_Fitas_Magnéticas.log");
						writer.Close();
					}
					else
					{
						File.Delete(@"D:\CheckFitaMagnetica\Log_de_Erros_Fitas_Magnéticas.log");
						StreamWriter writer = File.CreateText(@"D:\CheckFitaMagnetica\Log_de_Erros_Fitas_Magnéticas.log");
						writer.Close();
						richTextBox1.Clear();
					}
			...
			catch(Exception ex)
			{
                ...
                MessageBox.Show("O arquivo " + pathExterna + " não foi encontrado !");
			}
		}
		...
		{
			StreamWriter writer = File.AppendText(@"D:\CheckFitaMagnetica\Log_de_Erros_Fitas_Magnéticas.log");
			writer.Write(log);
			writer.WriteLine();
			writer.Close();
			if(telaFalseTtrue)
